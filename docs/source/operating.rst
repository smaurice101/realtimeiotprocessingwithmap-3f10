[realtimeiotprocessingwithmap-3f10] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [realtimeiotprocessingwithmap-3f10] container is NOT running**.

.. tip::
   You must have your [realtimeiotprocessingwithmap-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=35277  \-\-env VIPERVIZPORT=49081  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:49081/iot-failure-seneca.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:49081/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   maadsdocker/realtimeiotprocessingwithmap-3f10-amd64 (https://hub.docker.com/r/maadsdocker/realtimeiotprocessingwithmap-3f10-amd64)
...
.. important::
   docker run -d -p 35861:35861 -p 49397:49397 -p 36359:36359 \-\-env TSS=0 \-\-env SOLUTIONNAME=realtimeiotprocessingwithmap-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_dag-realtimeiotprocessingwithmap-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=35861  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=49397  \-\-env SOLUTIONVIPERVIZPORT=36359 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=35277 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=49081 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/realtimeiotprocessingwithmap-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=36359
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=35861
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - maadsdocker/realtimeiotprocessingwithmap-3f10-amd64
...
It can be accessed by entering: http://localhost:49397
...
.. important::
   http://localhost:36359/iot-failure-seneca.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:36359/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:36359/<html file>
...
[realtimeiotprocessingwithmap-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/realtimeiotprocessingwithmap-3f10
...
.. important::
   https://realtimeiotprocessingwithmap-3f10.readthedocs.io
...
.. important::
   solution_preprocessing_dag-realtimeiotprocessingwithmap-3f10
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=35861, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=43363, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=41961, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=41143, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=42933, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=39963, HPDEHOST=127.0.1.1, HPDEPORT=44757, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=35833

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6186-realtimeiotprocessingwithmap-3f10,solution_preprocessing_dag-realtimeiotprocessingwithmap-3f10, python-preprocess-770-realtimeiotprocessingwithmap-3f10,solution_preprocessing_dag-realtimeiotprocessingwithmap-3f10, python-preprocess2-9125-realtimeiotprocessingwithmap-3f10,solution_preprocessing_dag-realtimeiotprocessingwithmap-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
